...
pub const TX_SLOT_BYTE_SIZE: usize = 1_000_000;
...
pub const DEFAULT_MAX_TX_INPUT_BYTES: usize = 1_000_000; // 128KB

/// Maximum bytecode to permit for a contract.
pub const MAX_CODE_BYTE_SIZE: usize = 1_000_000;

/// Maximum initcode to permit in a creation transaction and create instructions.
/// HYBRID: Initcode size limit increased for the hybrid chain
pub const MAX_INIT_CODE_BYTE_SIZE: usize = 1_000_000;